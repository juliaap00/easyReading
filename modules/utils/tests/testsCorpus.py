...
corpus['Test 7 - Escalares'] = { 'originalText' : 'Corrímos todo lo que pudimos pero no llegamos a subirnos al bus.', #Inminencia	
'periphrasisList' : '[llegamos a subirnos]', 
'simplifiedText' : 'Corrímos todo lo que pudimos pero no nos subimos al bus.'#Debería no simplificase?
}
